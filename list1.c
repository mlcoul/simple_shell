...
/**
 * list_2_str - returns an array of strings of the list->str
 * @head: pointer to first node
 *
 * Return: array of strings
 */
char **list_2_str(list_t *head)
{
	list_t *node = head;
...
/**
 * node_str_with - returns node whose string starts with prefix
 ...
 */
list_t *node_str_with(list_t *node, char *prefix, char c)
{
	char *p = NULL;
